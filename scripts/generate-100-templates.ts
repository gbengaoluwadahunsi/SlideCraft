 ...
 * Generates 100 unique carousel templates with variations in:
 * - Color schemes
 * - Typography
 * - Layout styles
 * - Content themes
...
import { CarouselTemplate } from '../lib/templates';
...
function generateTemplate(
  ...
  fontFamily: string,
  theme: typeof CONTENT_THEMES[0],
  topic: string,
  layoutStyle: typeof LAYOUT_STYLES[0]
): CarouselTemplate {
  ...
  const slides = [
    {
      ...
      customBlocks: [],
      textAlign: layoutStyle.alignment as 'left' | 'center' | 'right',
    },
    {
...
export function generate100Templates(): CarouselTemplate[] {
